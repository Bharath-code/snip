...
async function acquireRateLimit() {
  // Wait for previous request to complete first
...
async function githubFetch(url, options = {}) {
  // Chain to previous request to ensure sequential rate limit checking
  let release;
  rateLimitPromise = new Promise((resolve) => { release = resolve; });
